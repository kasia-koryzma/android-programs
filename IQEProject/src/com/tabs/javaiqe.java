 ...
 *
 */
public class javaiqe implements Serializable {
     ...
     */
    public javaiqe(String key, String secret) {
        this.key = key;
        this.secret = secret;
    }
    ...
    public String upload(ArrayList<File> images, String name, String custom_id, String meta, boolean json, String collection) {
        ...
        */
        ...
        for (File image : images) {
            ...
            fields.put("" + ++index, image.getPath());
        }
        fields.put("name", name);
        fields.put("time_stamp", now());
        fields.put("api_key", null);
        fields.put("api_sig", buildSignature(fields));
    ...
    private String post(IQESelector selector, TreeMap<String, String> fields) {
        ...
        try {
            ...
            result = "Exception : UnsupportedEncodingException " + e.getMessage();
        } catch (IOException e) {
            result = "Exception : IOException " + e.getMessage();
        }
        return result;
    }
